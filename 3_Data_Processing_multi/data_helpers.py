...
class DataSet(object):
    ...
    def set_labels_2(self, labels_1, labels_2):
        self._labels_1 = labels_1
        self._labels_2 = labels_2
        
    def set_labels_3(self, labels_1, labels_2, labels_3):
        self._labels_1 = labels_1
        self._labels_2 = labels_2        
...
def set_data_sets_1(vectors_1, vectors_2, labels_1):
...
def set_data_sets_2(vectors_1, vectors_2, labels_1, labels_2):
    class DataSets(object):
        pass
    ...
    data_sets.train = DataSet(train_vectors_1, train_vectors_2)
    data_sets.train.set_labels_2(train_labels_1, train_labels_2)
    data_sets.test = DataSet(test_vectors_1, test_vectors_2)
    data_sets.test.set_labels_2(test_labels_1, test_labels_2)
...
def set_data_sets_3(vectors_1, vectors_2, labels_1, labels_2, labels_3):
    ...
    data_sets.train = DataSet(train_vectors_1, train_vectors_2)
    data_sets.train.set_labels_3(train_labels_1, train_labels_2, train_labels_3)
    data_sets.test = DataSet(test_vectors_1, test_vectors_2)
    data_sets.test.set_labels_3(test_labels_1, test_labels_2, test_labels_3)
    return data_sets
